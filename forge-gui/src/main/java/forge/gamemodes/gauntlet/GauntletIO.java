...
public class GauntletIO {
    ...
    public static GauntletData loadGauntlet(final File xmlSaveFile) {
        ...
        try (GZIPInputStream zin = new GZIPInputStream(Files.newInputStream(xmlSaveFile.toPath()));
            ...
            System.err.println("Corrupt gauntlet file found (ConversionException): " + xmlSaveFile.getName());
            // BugReporter.reportException(e); // Suppress GUI dialog in headless/watch mode
            isCorrupt = true;
