...
public class AIAgentClient {
    ...
    public AIAgentResponse requestDecision(AIAgentRequest request) throws AIAgentException {
        while (true) {
            ...
            try {
                System.out.println("AIAgentClient: Sending request to " + endpointUrl);
                ...
                System.out.println("AIAgentClient: Response code " + responseCode);
                if (responseCode != 200) {
                    throw new IOException("AI agent returned HTTP " + responseCode);
                }
                ...
                System.out.println(
                        "!! CONNECTION ERROR !! The game is paused. Please ensure manual_agent.py is running on "
                                + endpointUrl);
                ...
                try {
                    ...
                    throw new AIAgentException("Interrupted during retry", ie);
                }
            } finally {
                if (connection != null) {
